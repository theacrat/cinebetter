/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2a4bb06d47ffad517b22744a1c1ca32f)
// Runtime types generated with workerd@1.20251210.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/entry-cf");
	}
	interface Env {
		TMDB_TOKEN: string;
		TMDB_CATALOG_IMAGES: string;
		SQLITE_DB: string;
		IMDB_TMDB_D1: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TMDB_TOKEN" | "TMDB_CATALOG_IMAGES" | "SQLITE_DB">> {}
}
